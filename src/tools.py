...
def calculate_fitness_metrics(
    ...
    # Hydration: 35ml/kg + 0.5L for training
...
EXERCISE_DATABASE = [
    # Chest
    {"name": "Barbell Bench Press", "muscle": "Chest", "equipment": "Barbell", "compound": True, "contraindications": ["shoulder impingement", "rotator cuff"], "cues": "Retract scapulae, touch lower sternum, drive through feet.", "alternative": "Dumbbell Flat Bench Press"},
    {"name": "Incline Dumbbell Press", "muscle": "Chest", "equipment": "Dumbbell", "compound": True, "contraindications": ["shoulder pain"], "cues": "30-degree incline, control descent, press upward without clinking weights.", "alternative": "Incline Cable Press"},
    ...
    # Back
    {"name": "Barbell Bent-Over Row", "muscle": "Back", "equipment": "Barbell", "compound": True, "contraindications": ["lower back pain", "lumbar herniation"], "cues": "Hinge hips back, brace core, pull bar to lower ribcage.", "alternative": "Chest-Supported Dumbbell Row"},
    ...
    # Shoulders
    {"name": "Overhead Barbell Press", "muscle": "Shoulders", "equipment": "Barbell", "compound": True, "contraindications": ["shoulder impingement", "lower back pain"], "cues": "Brace core, glutes tight, press straight overhead.", "alternative": "Seated Dumbbell Shoulder Press"},
    {"name": "Seated Dumbbell Shoulder Press", "muscle": "Shoulders", "equipment": "Dumbbell", "compound": True, "contraindications": ["shoulder impingement"], "cues": "Palms slightly angled inward (scapular plane), press without arching back.", "alternative": "Machine Shoulder Press"},
    ...
    # Legs (Quads & Calves)
    {"name": "Barbell Back Squat", "muscle": "Quads", "equipment": "Barbell", "compound": True, "contraindications": ["knee pain", "patellar tendonitis", "lower back pain"], "cues": "Spread the floor, break at hips and knees simultaneously, chest upright.", "alternative": "Goblet Squat / Leg Press"},
    ...
    {"name": "Bulgarian Split Squat", "muscle": "Quads", "equipment": "Dumbbell", "compound": True, "contraindications": ["knee pain"], "cues": "Rear foot on bench, descend straight down, forward torso lean for glute focus.", "alternative": "Reverse Lunges"},
    ...
    {"name": "Romanian Deadlift (RDL)", "muscle": "Hamstrings/Glutes", "equipment": "Barbell", "compound": True, "contraindications": ["acute lower back pain"], "cues": "Soft knee bend, push hips directly backward, feel hamstring stretch.", "alternative": "Dumbbell RDL / Single-Leg RDL"},
    ...
    {"name": "Parallel Bar Dips / Bench Dips", "muscle": "Triceps", "equipment": "Bodyweight", "compound": True, "contraindications": ["shoulder instability"], "cues": "Torso upright for triceps, lower to 90 degrees.", "alternative": "Close-Grip Push-Ups"},

    # Core & Functional
    {"name": "Hanging Knee / Leg Raise", "muscle": "Core", "equipment": "Bodyweight", "compound": False, "contraindications": ["shoulder pain"], "cues": "Avoid swinging, curl pelvis upward toward chest.", "alternative": "Lying Leg Raise / Deadbugs"},
    ...
    {"name": "Cable Woodchoppers", "muscle": "Core", "equipment": "Cable", "compound": False, "contraindications": ["acute lower back disc issues"], "cues": "Rotate from thoracic spine and hips, keep arms extended.", "alternative": "Bicycle Crunches"}
]
